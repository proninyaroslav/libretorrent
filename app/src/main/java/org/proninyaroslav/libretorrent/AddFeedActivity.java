    ...
    implements FragmentCallback
{
    ...
    private static final String TAG_FEED_DIALOG = "add_feed_dialog";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        addFeedDialog = (AddFeedDialog)fm.findFragmentByTag(TAG_FEED_DIALOG);
        if (addFeedDialog == null) {
            ...
            addFeedDialog.show(fm, TAG_FEED_DIALOG);
        }
    }
