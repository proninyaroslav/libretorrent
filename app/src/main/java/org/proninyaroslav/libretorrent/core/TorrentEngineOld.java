...
public class TorrentEngineOld extends SessionManager
{
    @SuppressWarnings("unused")
    private static final String TAG = TorrentEngineOld.class.getSimpleName();
    ...
    {
        static final TorrentEngineOld INSTANCE = new TorrentEngineOld();
    }
    ...
    public void addListener(TorrentSessionListener callback)
    {
        listeners.add(callback);
    }

    public void removeListener(TorrentSessionListener callback)
    {
