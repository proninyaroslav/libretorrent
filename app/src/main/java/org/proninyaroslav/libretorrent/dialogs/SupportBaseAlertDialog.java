...
/*
 * The base alert dialog fragment (v4). Support customizing the layout, text, buttons, title and style.
...
public class SupportBaseAlertDialog extends DialogFragment
{
    ...
    private static final String TAG = SupportBaseAlertDialog.class.getSimpleName();
